...
COMMASPACE = ', '
subject = '高師大附中 110學年度第二學期 國際運算思維挑戰賽 挑戰證明'
from_addr = "mailer@zerojudge.tw"
app_passwd = "zridfkvaolgtoekp" # 應用程式密碼: 寄件信箱必須改為兩階段驗證
attachePath = 'C:\\Users\\user\\Downloads\\1102-bebras-六個班\\'
...
def main():
    ...
    for filename in attachments:
        ...
        to_addr = filename.split('.')[0] + '@' + to_domain  # 收件者 email
